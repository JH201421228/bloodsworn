...
> ❓ **TASK AT-07 — 타일셋 성격 확인 (Day 2, 60분).**
...
| 이벤트 | duration | intensity | 화면 이동량(≈) |
|---|---|---|---|
| 대시 | 60ms | 0.002 | 1.3px |
| 적 처치(엘리트) | 120ms | 0.003 | 1.9px |
| 플레이어 피격 | 120ms | 0.004 | 2.6px |
| 성수 낙하 착탄 | 100ms | 0.004 | 2.6px |
| 엘리트 등장 | 300ms | 0.006 | 3.8px |
| 보스 낫 착탄 | 200ms | 0.008 | 5.1px |
| 보스 등장 | 800ms | 0.012 | 7.7px |
| **각성** ★ | **500ms** | **0.015** | 9.6px |
| 플레이어 사망 | 400ms | 0.010 | 6.4px |
