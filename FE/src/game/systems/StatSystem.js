...
const BASE = {
    ...
    luck: 0,           // 카드 등급 상승 보정
    goldMult: 1,       // 획득 골드 배율. 성소 「탐욕」이 올린다.
                       // 스탯으로 둔 이유: 각성 「탐욕의 왕관」과 같은 축에서 곱해져야
                       // 두 배율이 서로를 모르는 채 이중 적용되는 일이 없다.
    itemFind: 1,       // 아이템 드롭 "확률" 배율. 등급까지 밀면 luck 과 두 축으로 곱해져
                       // 후반이 통제 불능이 된다 — 확률만 민다(23 문서 5)         // 카드 등급 상승 보정
};
